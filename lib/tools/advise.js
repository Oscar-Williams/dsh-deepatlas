...
import { CAPABILITY_PARAMETER_SCHEMA, extractCapabilities, normalizeCapabilityIds, resolveCapabilityClaims, } from '../core/capabilities.js';
...
export function buildAdviseTool(_ctx, config, dumpFn = makeDumpRunner(config.installProfile)) {
    return {
        ...
        async execute(args, execution) {
            ...
            if (!index)
                return asLosslessJson({ silent: true, reason: '索引不存在' });
